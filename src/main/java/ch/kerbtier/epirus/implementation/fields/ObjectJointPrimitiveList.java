...
public class ObjectJointPrimitiveList implements ObjectJoint, JointList {
  ...
  public ObjectJointPrimitiveList(ListEntity schema, EpirusObjectImplementation parent, PogoList pogoValue) {
    this.schema = schema;
    this.parent = parent;
